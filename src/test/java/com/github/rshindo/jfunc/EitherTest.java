...
class EitherTest {
    ...
    @Test
    void toResult_onRight_becomesSuccess() {
    ...
    @Test
    void toResult_onLeft_becomesFailure() {
        Either<String, Integer> either = Either.left("bad");

        Result<Integer, String> result = either.toResult();

        assertEquals(Result.failure("bad"), result);
    }
